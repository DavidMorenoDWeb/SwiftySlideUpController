...
class CommentsService {
    ...
    public func comments() -> [Comment] {
        ...
        let comments = [Comment(user: User(username: "John"), text: "Cool!"),
                        ...
                        Comment(user: User(username: "Francesc"), text: "I think clients would love this. Such colours, many background, so magnificent. Blur, shade, illustration, atmosphere – revolutionary m8."),
                        Comment(user: User(username: "Sarah"), text: "Mission accomplished. It's fabulous!!"),
